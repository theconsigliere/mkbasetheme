...
$id = 'ImageSideTextSide-' . $block['id'];
if( !empty($block['anchor']) ) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$className = 'ImageSideTextSide';
...
<section class="<?php echo esc_attr($className); ?>" id="<?php echo esc_attr($id); ?>"
    ...
    <div class="ImageSideTextSide__inner  ImageSideTextSide__inner--<?php echo $select; ?>"
        ...
        <div class="ImageSideTextSide__text">
            <div class="ImageSideTextSide__text-inner">
                <?php if ($title) : ?>
                <h3 class="ImageSideTextSide__title"><?php echo $title; ?></h3>
                <?php endif; ?>

                <?php if( have_rows('add_text') ): ?>
                <div class="ImageSideTextSide__text-group">
                    <?php while( have_rows('add_text') ) : the_row();                 
                    $desc = get_sub_field('description'); ?>
                    <p class='ImageSideTextSide__desc'><?php echo $desc; ?></p>
                    <?php endwhile; ?>
                </div>
                <?php endif;?>
